...
/*********************************************************************************/
	...
	var prologue_settings = {
		...
		// skelJS (probably don't need to change anything here unless you know what you're doing)
			skelJS: {
				prefix: '/QRocks/css/mobile/android/style',
				resetCSS: true,
				boxModel: 'border',
				useOrientation: true,
				breakpoints: {
				...
				panels: {
					panels: {
						sidePanel: {
							...
							position: 'left',
							size: 240,
							html: '<h:div data-action="moveElement" data-args="header"></h:div></h:div>'
						}
					},
					overlays: {
						sidePanelToggle: {
							...
							width: '3.5em',
							height: '2.25em',
							html: '<h:div data-action="togglePanel" data-args="sidePanel" class="toggle"></h:div>'
						}
					}
				}
			}
