...
// 			}
		...
		function mostrarConfirmacion(mensajeConfirmacion,okCallback){
			$('#modal').modal('show');
			$('#confirmText').text("");
			$('#confirmText').append(mensajeConfirmacion);
			$('#btnConfirm_ok').bind('click',okCallback);
			$('#btnConfirm_cancel').bind('click',function(){
				$('#modal').modal('hide');	
			});
		}
	</script>
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="dropdown ">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="${urlPedidosDomicilio}"><span class="glyphicon glyphicon-check"></span>Historial</a></li>
	    	...
	    	<div class="col-xs-12 col-centered">
	    		...
	    		<div class="well">
					...
					<div class="row">
  						...
  						<div class="col-md-4">
  							<div id="rightPanel">
  								<div id="cumpleanosDiv">
  									<div class="panel panel-default">
  										<div class="panel-heading" id="tituloPanelCuenta">
  											<div class="row">
  												<div class="col-sm-8">¿Quiénes cumplen años?</div>
  												<div class="col-sm-4" id="totalPanelCumple"> (0 personas)</div>
  											</div>
  										</div>
  										<div id="listaCumplanierosDiv" class="panel-body">
